...
fun BottomBar(navController: NavController) {
    ...
    val showBottomNavigation: Boolean = currentRoute.equals(Screen.HomeScreen.route) || currentRoute.equals(Screen.DevicesScreen.route) || currentRoute.equals(Screen.RoutinesScreen.route)
